** dinero                                                          :noexport:
[[https://clojars.org/io.github.sernamar/dinero][file:https://img.shields.io/clojars/v/com.sernamar/dinero.svg]]
...
- =fast money=: represents monetary amounts using a fixed scale, offering a balance between performance and accuracy while being precise enough for most applications.
...
#+end_src
#+end_quote
**** Monetary amounts of type =fast money=
